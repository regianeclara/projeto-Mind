...
module.exports = {
    ...
    async create(req,res){
        const {nome_usuario, sobrenome_usuario, cpf_usuario, email_usuario, tipo_usuario, senha_usuario} = req.body;
        let data = {};
        let user =  await Usuario.findOne({email_usuario});
        
        if(!user){
            data = {nome_usuario, sobrenome_usuario, cpf_usuario, email_usuario, tipo_usuario, senha_usuario};
    ...
    async update(req,res){
        const { _id, nome_usuario, sobrenome_usuario, cpf_usuario, email_usuario, senha_usuario, tipo_usuario } = req.body;
        const data = {nome_usuario, sobrenome_usuario, cpf_usuario, email_usuario, senha_usuario, tipo_usuario};
